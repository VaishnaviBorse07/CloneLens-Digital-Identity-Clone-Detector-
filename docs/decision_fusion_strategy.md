...
| Authenticity Score Range ($F$) | Final Classification Verdict | Risk Level | Action / Forensic Interpretation |
|---|---|---|---|
| $F \ge 0.70$ ($70\% - 100\%$) | **Human-Generated** | Low Risk | Content exhibits natural camera sensor physics and organic human linguistic entropy. |
| $0.50 \le F < 0.70$ ($50\% - 70\%$) | **Moderate** | Moderate Risk | Mixed indicators detected; subtle editing, high compression, or partial synthetic features present. |
| $F < 0.50$ ($0\% - 49.9\%$) | **AI-Generated** | High Risk | High probability of generative AI synthesis (GAN / Diffusion / LLM synthetic phrasing). |
